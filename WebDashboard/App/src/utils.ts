...
export function parseDateISOString(str: string): Date {
  ...
  switch (ds.length) {
    case 3:
      return new Date(ds[0], ds[1] - 1, ds[2]) // e.g. 2021-01-01
    case 4:
      return new Date(ds[0], ds[1] - 1, ds[2], ds[3]) // e.g. 2021-01-01T00
    case 5:
      return new Date(ds[0], ds[1] - 1, ds[2], ds[3], ds[4]) // e.g. 2021-01-01T00:00
    case 6:
      return new Date(ds[0], ds[1] - 1, ds[2], ds[3], ds[4], ds[5]) // e.g. 2021-01-01T00:00:00
    case 7:
      return new Date(ds[0], ds[1] - 1, ds[2], ds[3], ds[4], ds[5], ds[6]) // e.g. 2021-01-01T00:00:00.000
    default:
