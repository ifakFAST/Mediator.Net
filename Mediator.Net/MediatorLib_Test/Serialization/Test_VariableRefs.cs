...
{
    public class Test_VariableRefs
    {
        private readonly ITestOutputHelper console;

        public Test_VariableRefs(ITestOutputHelper console) {
        ...
        public void Test() {
            ...
            for (int i = 0; i < repeat; ++i) {
                ...
                VariableRef_Serializer.Serialize(stream, listA, Common.CurrentBinaryVersion);
                ...
                List<VariableRef> listB;
                listB = VariableRef_Serializer.Deserialize(stream);
