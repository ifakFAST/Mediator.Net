...
namespace Ifak.Fast.Mediator.BinSeri
{
    public static class VariableValue_Serializer
    {
        ...
        public static void Serialize(Stream stream, List<VariableValue> varVals) {
        ...
        public static List<VariableValue> Deserialize(Stream stream) {
            ...
            using (var reader = new BinaryReader(stream, Encoding.UTF8, leaveOpen: true)) {
                ...
                if (reader.ReadByte() != Version) throw new IOException("Failed to deserialize VariableValue[]: Wrong version byte");
