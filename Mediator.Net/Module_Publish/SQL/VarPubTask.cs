...
internal class VarPubTask {
    ...
    public static async Task MakeVarPubTask(SQLConfig config, ModuleInitInfo info, Func<bool> shutdown) {
    ...
    private static VariableValues Filter(VariableValues values, SQLVarPub config) {
